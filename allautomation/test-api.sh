...
UPDATED=$(curl -s -X PATCH http://localhost:5000/api/staff/tickets/2 -H "Authorization: Bearer $STAFF_TOKEN" -H "Content-Type: application/json" -d '{"status":"resolved","assignedTo":"D. Cole"}')
echo "$UPDATED"
